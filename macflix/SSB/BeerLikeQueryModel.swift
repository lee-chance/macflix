//
//  BeerLikeQueryModel.swift
//  macflix
//
//  Created by SSB on 13/09/2020.
//  Copyright © 2020 Changsu Lee. All rights reserved.
//

import Foundation

protocol BeerLikeQueryModelProtocol: class {
...
// 모든 클래스 중 가장 상위 클래스
class BeerLikeQueryModel: NSObject{
    var delegate: BeerLikeQueryModelProtocol!
    ...
    func parseJSON(_ data: Data){
        ...
        for i in 0..<jsonResult.count {
            ...
            DispatchQueue.main.async(execute: {() -> Void in
                self.delegate.beerItemDownloaded(items: locations)
