...
class SearchTableViewController: UITableViewController, QueryModelProtocol {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "searchmyCell", for: indexPath) as! TableViewCell
        // Configure the cell...
            let item: DBModel = feedItem[indexPath.row] as! DBModel // DB 모델타입으로 바꾸고, data 뽑아 쓸 수 있음
